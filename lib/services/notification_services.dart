...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(int hour, int minutes,int remaind,String repeate,String date) {
    ...
    scheduledDate= afterRemaind(remaind,scheduledDate)!;
    ...
    print('dkdjdjjddj = $scheduledDate');
    return scheduledDate;
  }
  tz.TZDateTime? afterRemaind(int remind,tz.TZDateTime scheduledDate){
    if(remind == 5){
 ...
 */
  ...
  void _configureSelectNotificationSubject() {
    selectNotificationSubject.stream.listen((String payload) async {
      ...
      await Get.to(() => NotificationScreen(payloade: payload,));
    });
  }
}
