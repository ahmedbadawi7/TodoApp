                  ...
                  children: [
                    Row(children:  const [
                     Icon(Icons.text_format,size: 30,color: Colors.white,),
                      SizedBox(width: 20,),
                      CustomText(size: 30, text: "title",color: Colors.white,),
                SizedBox(height: 20,),
                    ],
                    ),
                    const SizedBox(height: 20,),
                    Text(_playlode.toString().split('||')[1],style: TextStyle(color:Colors.white,fontSize: 20),textAlign: TextAlign.justify,),
                    Row(children: const [
                    ...
                    const SizedBox(height: 20,),
                    Text(_playlode.toString().split('||')[2],style: TextStyle(color:Colors.white,fontSize: 20),textAlign: TextAlign.justify,),
                    Row(children: const [
